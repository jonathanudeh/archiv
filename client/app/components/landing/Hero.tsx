  ...
  return (
    <section className="bg-background relative flex min-h-dvh flex-col overflow-hidden">
      ...
      <div className="archiv-container relative z-10 flex flex-1 flex-col items-center justify-center pt-15 pb-40 text-center">
        ...
        <div className="group relative mt-8 w-full max-w-3xl">
          ...
          <div className="relative overflow-hidden rounded-[28px] border border-white/80 bg-white/80 shadow-2xl shadow-slate-200/40 backdrop-blur-xl">
            ...
            <div className="relative flex items-center">
              ...
              <input
                type="text"
                placeholder="Search school, department, course, or material..."
                className="w-full bg-transparent py-6 pr-6 pl-4 text-[15px] text-slate-800 placeholder:text-slate-400 focus:outline-none"
              />
            </div>
          </div>
        </div>
        ...
        {/* Bottom Note */}
        <p className="mt-8 text-sm font-medium tracking-tight text-slate-400">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {/* top blur */}
        <div className="absolute top-[-10%] left-1/2 h-125 w-125 -translate-x-1/2 rounded-full bg-[#172033]/10 blur-3xl" />

        {/* paper gradients */}
        <div className="absolute bottom-0 left-0 h-[45%] w-full">
          <svg
            width="100%"
            height="100%"
          ...
          >
            <defs>
              <linearGradient id="grad-left" x1="0%" y1="0%" x2="100%" y2="0%">
                ...
                <stop offset="100%" stopColor="#C8D0DF" />
              </linearGradient>
